...
import { X, Sparkles, Coffee, Flame, CheckCircle, Tag, Thermometer, ShieldCheck, UtensilsCrossed, ExternalLink } from 'lucide-react';
          ...
          <div className="p-4 sm:p-6 bg-[#F7F6F2] border-t border-black/10 flex flex-col sm:flex-row items-center justify-between gap-3">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-2.5 w-full sm:w-auto">
              <a
                ...
                id="btn-modal-gofood-order"
                className="w-full sm:w-auto px-5 py-2.5 rounded-xl bg-[#EE2737] hover:bg-[#D31F2E] text-white text-xs font-bold flex items-center justify-center gap-2 shadow-sm hover:shadow-md transition-all cursor-pointer"
              >
              ...
              <button
                ...
                className="w-full sm:w-auto px-5 py-2.5 rounded-xl bg-[#1F4D3A] hover:bg-[#163A2C] text-white text-xs font-semibold flex items-center justify-center gap-2 shadow-sm hover:shadow-md transition-all cursor-pointer"
              >
